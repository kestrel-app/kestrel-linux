...
/// A sweep every 400ms puts twenty minutes across four seconds — about the pace
/// the service's own viewer runs at, and slow enough to follow a squall line
/// across a county.
...
///
/// Two thirds is about eight, and the cost of the extra is small now: the same
/// echo drawn twice at part opacity used to let a quarter of the map through
/// where the two agreed, and with the bands as rings and the two weighted by
/// their roots it is under a sixteenth.
const FADE: f32 = 0.65;
...
mod tests {
    ...
    fn the_crossing_is_the_end_of_a_step_and_no_more() {
        ...
        assert_eq!(blend(0.2), 0.0, "nor early in its own step");
