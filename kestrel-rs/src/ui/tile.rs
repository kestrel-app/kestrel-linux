...
impl Tile {
    ...
    fn paint_icon(painter: &egui::Painter, area: Rect, kind: EventKind) {
        ...
        let stroke = Stroke::new(1.4_f32, colour);
        ...
        match kind {
            ...
            EventKind::Package => {
                ...
                painter.line_segment(
                    ...
                    Stroke::new(1.2_f32, theme::INK),
                );
            }
            EventKind::Motion => {
                // Plain movement: a mark with radiating rings.
                painter.circle_filled(area.center(), h * 0.16, colour);
                painter.circle_stroke(area.center(), h * 0.34, Stroke::new(1.2_f32, colour));
                painter.circle_stroke(
                    area.center(),
                    h * 0.5,
                    Stroke::new(1.2_f32, colour.gamma_multiply(0.55)),
                );
            }
        }
    }
